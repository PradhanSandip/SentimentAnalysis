...
class Collocations:
    ...
    def extract_bigrams(self):
        ...
        print("#                                                                    #")
        print("######################################################################")
        print(self.positive_bigrams)
        print("######################################################################")
        print("#         Top 40 most important negative bigrams                     #")
        print("#                                                                    #")
        print("######################################################################")
        print(self.negative_bigrams)
       #positive bigram with part of speach tag
        ...
        print("#                                                                    #")
        print("######################################################################")
        print(self.positive_bigrams_pos_tag)
        ...
        print("#                                                                    #")
        print("######################################################################")
        print(self.negative_bigrams_pos_tag)
    ...
    def extract_trigrams(self):
        ...
        print("#                                                                     #")
        print("#######################################################################")
        print(self.positive_trigrams)
        print("#######################################################################")
        print("#         Top 40 most important negative trigrams                     #")
        print("#                                                                     #")
        print("#######################################################################")
        print(self.negative_trigrams)
        ...
        print("#                                                                     #")
        print("#######################################################################")
        print(self.positive_trigrams_pos_tag)
        print("#######################################################################")
        print("#    Top 40 most important negative trigrams with part of speach      #")
        print("#                                                                     #")
        print("#######################################################################")
        print(self.negative_trigrams_pos_tag)
c =Collocations()
c.extract_trigrams()